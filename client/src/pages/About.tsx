        ...
        <div className="container relative mx-auto px-4 h-full flex items-center">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-2xl text-gray-300 mb-12 leading-relaxed">
              ...
              trong lĩnh vực PC Gaming cao cấp tại Việt Nam
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-20 items-center">
            <div className="space-y-10">
              ...
              <p className="text-xl text-gray-300 leading-relaxed">
                Chúng tôi không chỉ đơn thuần là nơi bán PC Gaming, mà còn là
                người đồng hành đáng tin cậy trong hành trình nâng tầm trải
                nghiệm gaming của bạn.
              </p>
              ...
              <div key={member.name} className="group">
                <div className="relative p-8 bg-gradient-to-br from-gray-800/30 to-gray-900/30 backdrop-blur-sm rounded-3xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-700/30">
                  ...
                  <div className="mt-14">
                    ...
                    <p className="text-orange-500 text-center mb-6 font-medium">
                      {member.role}
                    </p>
      ...
      <section className="py-32 bg-gradient-to-r from-orange-500 via-red-500 to-purple-600 rounded-b-[2rem] relative overflow-hidden">
        ...
        <div className="container relative mx-auto px-4 text-center">
          ...
          <p className="text-2xl text-white/90 max-w-3xl mx-auto mb-12 leading-relaxed">
            Khám phá ngay các giải pháp PC Gaming tối ưu từ đội ngũ chuyên gia
            của chúng tôi
          </p>
          <Button
            size="lg"
...
const team = [
  {
    ...
    description:
      "15 năm kinh nghiệm trong lĩnh vực PC Gaming cao cấp, chuyên gia tư vấn giải pháp gaming đỉnh cao",
    img: ""
  },
  {
    name: "Trần Thị B",
    ...
    description:
      "Chuyên gia về thiết kế và tối ưu hóa hệ thống, 10 năm kinh nghiệm trong ngành công nghiệp gaming",
  },
  {
    name: "Lê Văn C",
